...
train_dir = '\\TSA\\Data\\Tumor\\Training'
test_dir = '\\TSA\\Data\\Tumor\\Testing'
batch_size=32
...
utils.save_model(model=model, target_dir='models', model_name=f'brain_tumor_vit_b_16_{epochs}_epochs.pth')
